...
\begin{frame}
  ...
  \begin{center}
      \only<+>{\includegraphics[width=.45\textwidth]{figs/one-caressed-1}}%
      \only<+->{\includegraphics[width=.45\textwidth]{figs/one-caressed-2}}
  \end{center}

  \uncover<+->{
   \noindent\textbf{Lemma:} Every leaf of $T_i$ contains at least one
   caressed face. 
  }
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[height=.7\textheight]{figs/cases-3}
    \uncover<2->{\includegraphics[height=.7\textheight]{figs/cases-4}}
  \end{center}
  \begin{itemize}
