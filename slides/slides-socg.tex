...
\begin{frame}
  ...
  \begin{center}
    \uncover<4->{{\color{blue}cycle in $\dual{G}$ of length $\ell=c\kappa\Delta^4$ \\ $\Downarrow$} \\}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    %  \color{red}T\color{orange}h\color{yellow}a\color{green}n\color{blue}k\color{purple}s\color{violet}!}\\
    % \centerline{\Huge
