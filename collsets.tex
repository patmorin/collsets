...
this process, we are no longer able to perform this operation, it is because $C$ caresses $\Omega(\ell'/\Delta^2)$ faces of $\dual{T}$ and we are done.  By the end of this process, the number of leaves in $T_0$ is at least $\ell/2\Delta=\Omega(\ell/\Delta)$ and we are also done.  This completes the proof of \thmref{main}.
