...
two components of $u\cap C$. Since $u$ is really really bad, the subgraph of $T_1$ induced by $N(u)$ consists
...
\end{figure}
\begin{enumerate}
   \item $q\subset C_x$.  In this case, we punt to Case~2. TODO!
   \lemref{one_edge_between} $a_1-C$ consists of two edges and exactly
   ...
   situation considered in Case~2, next.
...
%   and the nodes in $V(T_0')\cup V(T_1')$.
   ...
   \begin{enumerate}
     ...
     \item A path of edges shared with $x_i,\ldots,x_{i+j}$.
      ...
      Therefore, this part of the boundary of $a_0$ is contained in $C'$.
     ...
     only face whose colour goes from blue to red.)  This edge is therefore not contained in $C'$.
     ...
     is traversed in clockwise order. By \lemref{bad_one_shared_edge}
