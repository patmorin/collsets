\documentclass[a4paper,UKenglish,nolineno]{socg-lipics-v2019}
...
The proof of the following lemma---which is similar to that of \lemref{most-nodes-are-bad}---is ommitted due to space constraints.
...
\begin{figure}
   \begin{center}
     \begin{tabular}{ccc}
       \includegraphics[width=.3\textwidth]{figs/cases-2} &
       \includegraphics[width=.3\textwidth]{figs/cases-3} &
       \includegraphics[width=.3\textwidth]{figs/cases-4} \\
       (1) & (2) & $C'$
     \end{tabular}
   \end{center}
...
%   and the nodes in $V(T_0')\cup V(T_1')$.
   ...
   \begin{figure}
     \begin{center}
       \begin{tabular}{cc}
         \includegraphics[width=.45\textwidth]{figs/surgery-1} &
         \includegraphics[width=.45\textwidth]{figs/surgery-2} 
       \end{tabular}
     \end{center}
