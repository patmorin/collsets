...
contains an edge of $C_b$.  It follows from the \lemref{one-shared-edge}
...
the first $\Delta$ nodes of $X$ because, by \lemref{one-shared-edge},
...
such that $N(u)$ consists of at least 5 nodes (refer to \figref{surgery}.a):
\begin{enumerate}
...
\begin{figure}
   \begin{center}
   \begin{tabular}{cc}
    \multicolumn{2}{c}{\includegraphics{figs/surgery}} \\
    \multicolumn{2}{c}{(a)} \\[2em]
    \includegraphics{figs/surgery-a-1} & \includegraphics{figs/surgery-a-2} \\ 
...
, there is a single node
     ...
     $b_1,\ldots,b_s$.  Recall that, by \lemref{common-face} there is a single face $f$ of $\dual{T}$ contained in $u$ that has all edges of $u\cap C$
